...
Este projeto utiliza Regressão Logística para prever o risco de um paciente desenvolver doenças cardíacas nos próximos 10 anos, utilizando o dataset de Framingham. O objetivo principal é fornecer uma análise preditiva robusta com foco em interpretabilidade e alta taxa de detecção de pacientes em risco.
